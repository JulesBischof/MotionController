...
namespace MtnCtrl
{
    ...
    MovementTracker::MovementTracker(spiDevices::Tmc5240 *driver0, spiDevices::Tmc5240 *driver1)
    ...
    int32_t MovementTracker::getRotation()
    {
    ...
    int32_t MovementTracker::getDistance()
    {
        int32_t xActualDriver0 = _driver0->getXActual();
        int32_t xActualDriver1 = _driver1->getXActual();
    ...
    void MovementTracker::addOffsetMillimeters(uint16_t offsetMm)
    {
        _offsetMm = offsetMm;
    }
}