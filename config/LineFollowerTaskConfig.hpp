...
constexpr float LINEFOLLERCONFIG_VMAX_STRAIGHT_FORWARD_PERCANTAGE = (0.9);
constexpr float LINEFOLLERCONFIG_AMAX_STRAIGHT_FORWARD_PERCANTAGE = (0.8);
...
constexpr uint32_t LINEFOLLOWERCONFIG_DISTANCE_PER_LINE_POLLCYCLE_MM = V_MAX_IN_MMPS * (LINEFOLLOWERCONFIG_POLLING_RATE_MS / 1000.f); // mm per Polling Cycle