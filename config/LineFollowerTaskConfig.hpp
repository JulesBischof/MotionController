...
constexpr float LINEFOLLERCONFIG_AMAX_TURN_PERCANTAGE = (0.05);
...
// Barrier Handling
constexpr float SLOWDOWNDISTANCE_BARRIER_IN_MM = (320.f); // 290
constexpr float BRAKEDISTANCE_BARRIER_IN_MM = DISTANCE_UNTIL_STANDSTILL_IN_MM + 10; // 100
