...
#define LINEFOLLERCONFIG_AMAX_REGISTER_VALUE (4500) // 6500

/* --- straight velocity params ------ */
#define LINEFOLLERCONFIG_VMAX_STRAIGHT_BACKWARDS_PERCANTAGE (0.5)
#define LINEFOLLERCONFIG_AMAX_STRAIGHT_BACKWARDS_PERCANTAGE (0.2)
...
#define LINEFOLLERCONFIG_VMAX_TURN_PERCANTAGE (0.4)
#define LINEFOLLERCONFIG_AMAX_TURN_PERCANTAGE (0.5)
