...
constexpr float LINEFOLLERCONFIG_VMAX_STRAIGHT_BACKWARDS_PERCANTAGE = (0.75); // 0.5
constexpr float LINEFOLLERCONFIG_AMAX_STRAIGHT_BACKWARDS_PERCANTAGE = (0.1);

constexpr float LINEFOLLERCONFIG_VMAX_STRAIGHT_FORWARD_PERCANTAGE = (1.0);
constexpr float LINEFOLLERCONFIG_AMAX_STRAIGHT_FORWARD_PERCANTAGE = (0.9);
...
constexpr float LINEFOLLERCONFIG_AMAX_TURN_PERCANTAGE = (0.3); // 0.05
...
============================================================== */
constexpr float LINEFOLLOWERCONFIG_AXIS_WIDTH_mm(264); //  // -240 old wheels - 272 - using CAD
constexpr float LINEFOLLOWERCONFIG_DISTANCE_LINESENSOR_TO_AXIS_mm(91.f); //111
...
// Barrier Handling
constexpr float SLOWDOWNDISTANCE_BARRIER_IN_MM = (330.f); // 290
constexpr float BRAKEDISTANCE_BARRIER_IN_MM = DISTANCE_UNTIL_STANDSTILL_IN_MM + 20; // 100
