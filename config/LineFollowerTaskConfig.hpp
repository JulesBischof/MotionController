...
#define LINEFOLLERCONFIG_VMAX_REGISTER_VALUE (2 * 75000)
#define LINEFOLLERCONFIG_AMAX_REGISTER_VALUE (6500) // 6500
...
// Barrier Handling
#define BRAKEDISTANCE_BARRIER_IN_MM (200.f) // 110
#define LINEFOLLOWERCONFIG_BARRIER_GRIP_DISTANCE_mm (27)
#define LINEFOLLOWERCONFIG_BARRIER_GRIP_DISTANCE_TOLAREANCE_mm (5)
#define LINEFOLLOWERCONFIG_BARRIER_SET_BACK_DISTANCE_mm (250)
